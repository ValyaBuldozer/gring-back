...
def upgrade():
    ...
    op.create_foreign_key(None, 'object', 'locale_link', ['object_audioguide_link_id'], ['string_id'])
    ...
    op.create_foreign_key(None, 'route_place_info', 'locale_link', ['route_place_audioguide_link_id'], ['string_id'])
